...
export default function Chat({videoId} : {videoId : string | undefined}) {
  ...
  const handleSendMessage = async () => {
    ...
    setMessages((prev) => [...prev, {
        party : "bot",
        message : chatResponse.data.data as string,
    }]);
    setInput("");
  ...
  return (
    <div className="w-full h-[80vh] flex flex-col items-center justify-between rounded-2xl overflow-hidden bg-gray-50 shadow-lg">
      <div
